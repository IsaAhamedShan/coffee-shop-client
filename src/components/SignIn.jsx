...
const SignIn = () => {
  ...
  const unsuccessfulLogin = () => toast.error("Email/Password mismatch");
        ...
        login(email,password).then(result =>{
         ...
         .then(res=>res.json())
         .then(data=>{console.log(data); successfulLogin();})
         setSignInSuccess(true)
         
         navigate('/')
        }
        )
        .catch(error => {console.log(error); unsuccessfulLogin()})
            ...
            <form className="card-body " onSubmit={handleSignIn}>
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-bold text-[#1F0E0B]">EMAIL</span>
                </label>
                <input
                  type="email"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text font-bold text-[#1F0E0B]">PASSWORD</span>
                </label>
